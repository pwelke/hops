...
Expects two input files in the following order:

* A vertex label list file with the format
vertex_1_label
vertex_2_label
...

* An edge list file of the format
vertex_x1 vertex_y1 label_id
vertex_x2 vertex_y2 label_id
...

All entries in the files are expected to be integers.
...
if __name__ == '__main__':
	vertexlabels = np.loadtxt(sys.argv[1])
	edges = undirected_edges(np.loadtxt(sys.argv[2]))
