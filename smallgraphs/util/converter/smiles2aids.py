...
'''Transform a smi or smiles file containing a bunch of molecules to the format needed by 
...
for line in infile:
	#input
	moleculesmile = line.split()[0]
	obconversion.ReadString(obmol, moleculesmile)
	#output
