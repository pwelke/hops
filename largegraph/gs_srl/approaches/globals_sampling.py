...
class Furer_reports:
    ...
    def __init__(self,iteration_number,current_fdict,number_of_observed_nodes,recorded_at_time,duration):
        ...
        self.sum_nr_embeddings=globals_sampling.sum_number_of_embeddings
        self.sum_of_the_square_embeddings=globals_sampling.sum_of_the_square_embeddings
        
        self.sum_nr_embeddings_aux=globals_sampling.sum_number_of_embeddings_aux
        self.sum_of_the_square_embeddings_aux=globals_sampling.sum_squared_number_of_embeddings_aux
        
        self.nr_iterations=globals_sampling.nr_iterations
        self.population_mean_random=globals_sampling.population_mean_random
        self.population_stdev_random=globals_sampling.population_stdev_random
        self.nr_root_nodes=globals_sampling.nr_root_nodes
        self.nr_root_nodes_observed_so_far=globals_sampling.nr_root_nodes_observed_so_far
        self.last_seen_root_node=globals_sampling.last_seen_root_node
        self.sum_nr_extra_embeddings=globals_sampling.sum_number_of_extra_embeddings
        self.sum_of_the_extra_square_embeddings=globals_sampling.sum_of_the_square_extra_embeddings
        self.embeddings_estimate=globals_sampling.embeddings_estimate
