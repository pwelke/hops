...
if __name__ == '__main__':
    ...
    fdictionaries_Furer = approaches.globals_sampling.globalist_furer
    times_Furer = approaches.globals_sampling.globaltimes_furer[1:]
