...
from report_results import make_excel_files_results as excel
...
def get_row(pattern,general_path,pattern_result,experiment_name,pattern_path):
    row={}
    pattern=nx.read_gml(pattern)
    ...
    for i in range(0,len(emb_stds)):
        row["std_"+str(i+1)]=emb_stds[i]
    
    for i in range(0,len(klds)):
